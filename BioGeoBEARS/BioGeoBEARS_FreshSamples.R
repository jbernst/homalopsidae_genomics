...
#wd = np("~")
#setwd(wd)
setwd("D:/Documents/Homalopsidae_Phylogenomics/BioGEOBEARS_Fresh-No-areas_allowed/BioGEOBEARS/")
...
#ladderize left to right 
tree <- read.tree(file="homalopsidae_datedtree_best.newick")
treelladder<-ladderize(tree, right = "TRUE")
write.tree(treelladder, file="homalopsidae.lladder.newick")

pruned.tree<-read.tree(file="homalopsidae.lladder.newick")

species<-c("Bothrops_moojeni_SRS2115278", "Bothrops_pauloensis_SRS2115295", "Micrurus_brasiliensis_SRS2115293", "Chironius_exoletus_SRS2115290", "Philodryas_olfersii_SRS2115301")

pruned.tree<-drop.tip(pruned.tree, species)

write.tree(pruned.tree, file="homalopsidae.pruned_ingroup_species_best.lladder.newick")
plot(pruned.tree)
#Just start from here if you are doing the analysis again as we already have the pruned tree (line 108)
#read.tree(file = "homalopsidae.pruned_ingroup_species.lladder.newick")
trfn = "homalopsidae.pruned_ingroup_species_best.lladder.newick"
geogfn = "geo3.data"
...
runslow = TRUE
resfn = "homalopsidae_DEC_M0_unconstrained_v1.Rdata" #This is ging to be created
if (runslow)
{
...
resfn = "homalopsidae_DEC+J_M0_unconstrained_v1.Rdata"
runslow = TRUE
if (runslow)
{
...
#######################################################
#quartz()
pdffn = "homalopsidae_DEC_vs_DEC+J_M0_unconstrained_v1.pdf"
...
analysis_titletxt ="BioGeoBEARS DEC on Homalopsidae M0_unconstrained"
...
# States
res2 = plot_BioGeoBEARS_results(results_object, analysis_titletxt, addl_params=list("j"), plotwhat="text", label.offset=0.4, tipcex=1.5, statecex=0.6, splitcex=0.6, titlecex=1.5, plotsplits=TRUE, cornercoords_loc=scriptdir, include_null_range=TRUE, tr=tr, tipranges=tipranges)

# Pie chart
plot_BioGeoBEARS_results(results_object, analysis_titletxt, addl_params=list("j"), plotwhat="pie", label.offset=0.4, tipcex=1.5, statecex=0.6, splitcex=0.6, titlecex=1.5, plotsplits=TRUE, cornercoords_loc=scriptdir, include_null_range=TRUE, tr=tr, tipranges=tipranges)
...
#######################################################
analysis_titletxt ="BioGeoBEARS DEC+J on Homalopsidae M0_unconstrained"
...
# States
res1 = plot_BioGeoBEARS_results(results_object, analysis_titletxt, addl_params=list("j"), plotwhat="text", label.offset=0.4, tipcex=1.5, statecex=0.6, splitcex=0.6, titlecex=1.5, plotsplits=TRUE, cornercoords_loc=scriptdir, include_null_range=TRUE, tr=tr, tipranges=tipranges)
...
runslow = TRUE
resfn = "homalopsidae_DIVALIKE_M0_unconstrained_v1.Rdata"
if (runslow)
{
  res = bears_optim_run(BioGeoBEARS_run_object)
  res    
...
resfn = "Homalopsidae_DIVALIKE+J_M0_unconstrained_v1.Rdata"
runslow = TRUE
if (runslow)
{
  #sourceall("/Dropbox/_njm/__packages/BioGeoBEARS_setup/")
...
pdffn = "Homalopsidae_DIVALIKE_vs_DIVALIKE+J_M0_unconstrained_v1.pdf"
pdf(pdffn, width=10, height=13)

#######################################################
# Plot ancestral states - DIVALIKE
#######################################################
analysis_titletxt ="BioGeoBEARS DIVALIKE on Homalopsidae M0_unconstrained"
...
# States
res2 = plot_BioGeoBEARS_results(results_object, analysis_titletxt, addl_params=list("j"), plotwhat="text", label.offset=0.1, tipcex=1.5, statecex=0.4, splitcex=0.4, titlecex=1.5, plotsplits=TRUE, cornercoords_loc=scriptdir, include_null_range=TRUE, tr=tr, tipranges=tipranges)

# Pie chart
plot_BioGeoBEARS_results(results_object, analysis_titletxt, addl_params=list("j"), plotwhat="pie", label.offset=0.1, tipcex=1.5, statecex=0.4, splitcex=0.4, titlecex=1.5, plotsplits=TRUE, cornercoords_loc=scriptdir, include_null_range=TRUE, tr=tr, tipranges=tipranges)

#######################################################
# Plot ancestral states - DIVALIKE+J
#######################################################
analysis_titletxt ="BioGeoBEARS DIVALIKE+J on Homalopsidae M0_unconstrained"
...
# States
res1 = plot_BioGeoBEARS_results(results_object, analysis_titletxt, addl_params=list("j"), plotwhat="text", label.offset=0.1, tipcex=1.5, statecex=0.4, splitcex=0.4, titlecex=1.5, plotsplits=FALSE, cornercoords_loc=scriptdir, include_null_range=TRUE, tr=tr, tipranges=tipranges)

# Pie chart
plot_BioGeoBEARS_results(results_object, analysis_titletxt, addl_params=list("j"), plotwhat="pie", label.offset=0.1, tipcex=1.5, statecex=0.4, splitcex=0.4, titlecex=1.5, plotsplits=FALSE, cornercoords_loc=scriptdir, include_null_range=TRUE, tr=tr, tipranges=tipranges)
...
runslow = TRUE
resfn = "homalopsidae_BAYAREALIKE_M0_unconstrained_v1.Rdata"
if (runslow)
{
  res = bears_optim_run(BioGeoBEARS_run_object)
  res    
...
resfn = "homalopsidae_BAYAREALIKE+J_M0_unconstrained_v1.Rdata"
runslow = TRUE
if (runslow)
{
  res = bears_optim_run(BioGeoBEARS_run_object)
...
pdffn = "Homalopsidae_BAYAREALIKE_vs_BAYAREALIKE+J_M0_unconstrained_v1.pdf"
pdf(pdffn, width=10, height=13)

#######################################################
# Plot ancestral states - BAYAREALIKE
#######################################################
analysis_titletxt ="BioGeoBEARS BAYAREALIKE on Homalopsidae M0_unconstrained"
...
#######################################################
analysis_titletxt ="BioGeoBEARS BAYAREALIKE+J on Homalopsidae M0_unconstrained"
...
# States
res1 = plot_BioGeoBEARS_results(results_object, analysis_titletxt, addl_params=list("j"), plotwhat="text", label.offset=0.1, tipcex=0.8, statecex=0.4, splitcex=0.4, titlecex=1.5, plotsplits=FALSE, cornercoords_loc=scriptdir, include_null_range=TRUE, tr=tr, tipranges=tipranges)
...
#######################################################
# Your results should be (THIS IS AN EXAMPLE):
#######################################################
